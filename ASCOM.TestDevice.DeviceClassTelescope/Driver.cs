...
//
// ASCOM Telescope driver for TestDevice
//
...
namespace ASCOM.TestDevice
{
    //
    // Your driver's DeviceID is ASCOM.TestDevice.Telescope
    //
    // The Guid attribute sets the CLSID for ASCOM.TestDevice.Telescope
    // The ClassInterface/None attribute prevents an empty interface called
    // _TestDevice from being created and used as the [default] interface
    //
    ...
    /// ASCOM Telescope Driver for TestDevice.
    /// </summary>
    [Guid("fb4cf409-4a09-4c04-bf23-23305da86437")]
    ...
    public class Telescope : ITelescopeV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.TestDevice.Telescope";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Telescope Driver for TestDevice.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestDevice"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Telescope()
        {
            tl = new TraceLogger("", "TestDevice");
